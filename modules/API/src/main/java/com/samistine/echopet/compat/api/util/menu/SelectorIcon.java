...
import com.samistine.echopet.libraries.dshutils.inventory.MenuIcon;
...
public class SelectorIcon extends MenuIcon {
    ...
    public ItemStack getIcon(Player viewer) {
        ...
        ChatColor c = this.petType == null ? ChatColor.YELLOW : (viewer.hasPermission("echopet2.pet.type." + this.getPetType().toString().toLowerCase().replace("_", ""))) ? ChatColor.GREEN : ChatColor.RED;
