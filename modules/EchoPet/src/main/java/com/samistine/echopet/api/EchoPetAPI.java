...
public class EchoPetAPI {
    ...
    /**
     * Gives a {@link com.samistine.echopet.api.pet.Pet} to the specified {@link Player}
     * <p/>
     * Pets will be spawned immediately next to the target player, linked until it is removed.
     *
     * @param player      the {@link org.bukkit.entity.Player} that will be provided with a {@link com.samistine.echopet.api.pet.Pet}
     * @param petType     the {@link com.samistine.echopet.compat.api.entity.PetType} (type of {@link com.samistine.echopet.api.pet.Pet}) that will be given to the player
     * @param sendMessage defines if the plugin sends a message to the target {@link Player}
     * @return the {@link com.samistine.echopet.api.pet.Pet} created
     */
    ...
    /**
     * Removes a {@link com.samistine.echopet.api.pet.Pet} if the {@link org.bukkit.entity.Player} has one active
     *
     * @param player      the {@link org.bukkit.entity.Player} to remove their {@link com.samistine.echopet.api.pet.Pet} from
    ...
    /**
     * Checks if a {@link org.bukkit.entity.Player} has a {@link com.samistine.echopet.api.pet.Pet}
     *
     * @param player the {@link org.bukkit.entity.Player} used to check for {@link com.samistine.echopet.api.pet.Pet}
     * @return true if {@link org.bukkit.entity.Player} has a {@link com.samistine.echopet.api.pet.Pet}, false if not
     */
    ...
    /**
     * Gets a {@link org.bukkit.entity.Player}'s {@link com.samistine.echopet.api.pet.Pet}
     *
     * @param player the {@link org.bukkit.entity.Player} to get the {@link com.samistine.echopet.api.pet.Pet} of
     * @return the {@link com.samistine.echopet.api.pet.Pet} instance linked to the {@link org.bukkit.entity.Player}
     */
    ...
    /**
     * Gets all active {@link com.samistine.echopet.api.pet.Pet}
     *
     * @return an array of all active {@link com.samistine.echopet.api.pet.Pet}s
     */
    ...
    /**
     * Teleports a {@link com.samistine.echopet.api.pet.Pet} to a {@link org.bukkit.Location}
     *
     * @param pet      the {@link com.samistine.echopet.api.pet.Pet} to be teleported
     * @param location the {@link org.bukkit.Location} to teleport the {@link com.samistine.echopet.api.pet.Pet} to
     * @return success of teleportation
     */
    public boolean teleportPet(IPet pet, Location location) {
        if (pet == null) {
            ConsoleLogger.log(Logger.LogLevel.SEVERE, "Failed to teleport Pet to Location through the EchoPetAPI. {@link com.samistine.echopet.api.pet.Pet} cannot be null.");
            return false;
        }
    ...
    /**
     * Save a {@link com.samistine.echopet.api.pet.Pet} to file or an SQL Database
     *
     * @param pet      {@link com.samistine.echopet.api.pet.Pet} to be saved
    ...
    /**
     * Adds {@link com.samistine.echopet.compat.api.entity.PetData} to a {@link com.samistine.echopet.api.pet.Pet}
     *
     * @param pet     the {@link com.samistine.echopet.api.pet.Pet} to add the data to
     * @param petData {@link com.samistine.echopet.compat.api.entity.PetData} to add to the {@link com.samistine.echopet.api.pet.Pet}
     */
    ...
    /**
     * Removes {@link PetData} from a {@link com.samistine.echopet.api.pet.Pet}
     *
     * @param pet     the {@link com.samistine.echopet.api.pet.Pet} to remove the data from
     * @param petData {@link PetData} to remove to the {@link com.samistine.echopet.api.pet.Pet}
     */
    ...
    /**
     * Checks if a {@link com.samistine.echopet.api.pet.Pet} has specific {@link PetData}
     *
     * @param pet     the {@link com.samistine.echopet.api.pet.Pet} to search
     * @param petData the {@link PetData} searched for in the {@link com.samistine.echopet.api.pet.Pet} instance
     * @return true if the {@link com.samistine.echopet.api.pet.Pet} has the specified {@link PetData}
     */
    ...
    /**
     * Set a target for the {@link com.samistine.echopet.api.pet.Pet} to attack
     *
     * @param pet    the attacker
     * @param target the {@link org.bukkit.entity.LivingEntity} for the {@link com.samistine.echopet.api.pet.Pet} to attack
     */
    ...
    /**
     * Get the {@link org.bukkit.entity.LivingEntity} that a {@link com.samistine.echopet.api.pet.Pet} is targeting
     *
     * @param pet the attacker
    ...
    /**
     * Add a predefined {@link com.samistine.echopet.compat.api.ai.PetGoal} to a {@link com.samistine.echopet.api.pet.Pet} from the API
     *
     * @param pet      the {@link com.samistine.echopet.api.pet.Pet} to add the goal to
    ...
    /**
     * Add an implementation of {@link com.samistine.echopet.compat.api.ai.PetGoal} to a {@link com.samistine.echopet.api.pet.Pet}
     *
     * @param pet        the {@link com.samistine.echopet.api.pet.Pet} to add the {@link com.samistine.echopet.compat.api.ai.PetGoal} to
     * @param goal       the {@link com.samistine.echopet.compat.api.ai.PetGoal} to add
    ...
    /**
     * Remove a predefined goal from a {@link com.samistine.echopet.api.pet.Pet}'s AI
     *
     * @param pet      {@link com.samistine.echopet.api.pet.Pet} to remove the goal from
     * @param goalType type of goal
     */
    ...
    /**
     * Remove a goal from a {@link com.samistine.echopet.api.pet.Pet}'s AI
     * <p/>
     * The goal is identified using a string, initiated when the goal is added to the {@link com.samistine.echopet.api.pet.Pet}
     *
     * @param pet        {@link com.samistine.echopet.api.pet.Pet} to remove the goal from
     * @param identifier String that identifies a {@link com.samistine.echopet.compat.api.ai.PetGoal}
     */
     ...
     *
     * @param pet     {@link com.samistine.echopet.api.pet.Pet} to remove the goal from
     * @param petGoal {@link com.samistine.echopet.compat.api.ai.PetGoal} to remove
     */
    ...
    /**
     * {@link Enum} of predefined {@link com.samistine.echopet.compat.api.ai.PetGoal}s
     */
    ...
    /**
     * Types used for saving {@link com.samistine.echopet.api.pet.Pet}s
     */
